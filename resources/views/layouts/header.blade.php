            ...
            <div class="header-left">
                <div class="dropdown for-notification">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="notification"
                        ...
                        <span class="count bg-danger" id="notifi-count">0</span>
                    </button>
                    <div class="dropdown-menu" aria-labelledby="notification" id="list_notifi" hidden="">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @if (Auth::user()->image)
                        <img class="user-avatar rounded-circle"
                             src="{{ asset(config('asset.image_path.avatar') . $currentUser->image) }}"
                             alt="User Avatar">
                    @else
                        <img class="user-avatar rounded-circle" src="{{ asset('images/default.jpeg') }}"
                             alt="User Avatar">
                    @endif
                </a>
